...
def add_records(tvs: list):
    try:
        ...
        command = "INSERT INTO walmart VALUES(%s)"
        
        walmart_tvs = scrape_walmart_tvs()
        ...
        values = ','.join( ('(%s,%s,%s,%s,%s,%s,%s,%s,%s)'\
                    ...
                    for tv in walmart_tvs )
        
        curr = conn.cursor()
        curr.execute('INSERT INTO walmart VALUES' + values + ';')
