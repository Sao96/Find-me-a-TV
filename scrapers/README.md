...
`add_records()`: Adds TV records to a specificed databases store table. The function expects a list of TV's, and parses them into a format possible to pass as a record value for the psql DB.
