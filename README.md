# Find-me-a-TV
Find Me a TV (FMaT) is a website that displays TV's from all around the web, giving users an easy way to search for TV's from all around the web. A live version of this application can be found at https://findme-a-tv.herokuapp.com/.
...
This component can be found within the `scrapers` directory.
